...
Synology. Он получает исходный код из исправленного коммита ветки
`deploy/openspool-qr-nas`, собирает новый интерфейс и накладывает его на
официальный серверный образ Spoolman 0.26.1. Фиксированный коммит и тег образа
не позволяют Synology повторно использовать старую сборку. База данных и старый
интерфейс при этом не изменяются.
...
```text
https://github.com/sitnikovv/Spoolman.git#092d328eb706e41435ff2cd7fa3b150b5c66536e
```
